...
for (var i = 1; i <= 5; i++) {
    ...
    thumb.src = "assets/images/browser__apps/attendance__tracker/attendance__tracker__0" + i + ".jpg";
...
for (var i = 1; i <= 4; i++) {
    var thumb = document.createElement("img");
    thumb.src = "assets/images/browser__apps/countdown__timer/countdown__timer__0" + i + ".jpg";
